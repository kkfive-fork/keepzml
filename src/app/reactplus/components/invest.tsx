  ...
  return (
    <motion.div {...variants(0.1)} className='p-4 md:p-8 border-gray-200 border rounded keep'>
      ...
      <p className='space-x-2 mt-2'>
        ...
        本专栏原价 <strong className='text-red-500'>1000 元</strong>。由于目前内容正在创作过程中，特推出 2 折优惠购买，该活动持续时间不会很长，不要错过机会哦。其他说明：购买之后请务必进群交流学习心得，群内提供答疑服务，以及不定时直播讲解。目前群内学习氛围良好，欢迎加入。
      </p>

      <ul>
        <li>在我这里消费大于等于 2w，可获得本站全局阅读权限</li>
        <li>购买过《学霸级学习方法》，可获得叠加半价优惠</li>
        <li>本专栏将会与 React 知命境基础版同步创作</li>
      </ul>

      <div className='text-right'>
        <Link href={column_url} target='_blank'>
          <Button signal>{subscrible.reactplus === 1 ? '您已订阅' : '200 元 . 立即订阅'}</Button>
        </Link>
      </div>
    </motion.div>
  )
